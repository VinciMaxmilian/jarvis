# Graph Report - jarvis  (2026-07-31)

## Corpus Check
- 213 files · ~286,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3333 nodes · 7368 edges · 175 communities (150 shown, 25 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 446 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47e7f5d9`
...
Cohesion: 0.11
Nodes (19): devDependencies, autoprefixer, oxlint, postcss, tailwindcss, @types/react, @types/react-dom, vite (+11 more)
